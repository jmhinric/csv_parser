...
ActiveRecord::Base.transaction do
  ...
  # Cost Analysis
  ##################################################################################################
  def cost_analysis_template(user)
  ...
  cost_analysis_template(user)
  example2_template(user)

  user2 = User.create!(email: "tom.mikolajczyk@alliant.com ", password: "password", password_confirmation: "password")
  cost_analysis_template(user2)
end
